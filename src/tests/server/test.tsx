...
export async function test(
...

  {
    ...
    {
      {
        const left = toJSON(<App request={new Request(url)} />)[
          Symbol.asyncIterator
        ]();
        const right = toJSON(<Fetch url={url} fetch={fetch} />)[
          Symbol.asyncIterator
        ]();
